...
spriterot -v -r 64 -o ../../source/images/rider/upper-arm-table-16-16.png ./rider/upper-arm.png
spriterot -v -r 64 -o ../../source/images/rider/lower-arm-table-12-12.png ./rider/lower-arm.png
spriterot -v -r 64 -o ../../source/images/rider/upper-leg-table-16-16.png ./rider/upper-leg.png
