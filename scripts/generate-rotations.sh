...
spriterot -v -r 64 --width 22 --height 22 -o ../../source/images/bike-wheel-table-22-22.png ./wheel.png
spriterot -v -r 64 --width 22 --height 22 -o ../../source/images/bike-ghost-wheel-table-22-22.png ./ghost-wheel.png
spriterot -v --width 48 --height 48 -k -r 64 -o ../../source/images/bike-chassis-table-48-48.png ./bike-chassis.png
