...
echo "Parent directory of the input: $DESTINATION_DIR"
...
# Create an empty file "main.lua" in the source directory
echo "Creating an empty file main.lua in the source directory"
