...
var jobs: seq[PreloadJob] = @[
  ...
  PreloadJob(timeCost: 0.005.Seconds, jobType: PreloadJobType.SoundSample, sampleId: SampleId.SelectPrevious),  
  ...
  PreloadJob(timeCost: 0.009.Seconds, jobType: PreloadJobType.BitmapTable, bitmapTableId: BitmapTableId.Confetti),
  PreloadJob(timeCost: 0.006.Seconds, jobType: PreloadJobType.BitmapTable, bitmapTableId: BitmapTableId.Trophy),
