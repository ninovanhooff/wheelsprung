...
let officialLevels*: OrderedTable[Path, LevelMeta] = @[
  ...
  newLevelMeta(name= "Leap of Faith", path="levels/leap_of_faith.flatty", theme= Desk, hash="85FE36BD0DBA06FFE16174ECC899EE67", boardId = "leapoffaith"),
  ...
  newLevelMeta(name= "Go Nuts!", path="levels/paradise.flatty", theme= Space, hash="4DB7D7B9F863C9D56801A018CAFE353A", boardId = "paradise"),
]
