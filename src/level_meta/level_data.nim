...
let officialLevels*: OrderedTable[Path, LevelMeta] = @[
  ...
  newLevelMeta(name= "Ripple Ride", path="levels/hills.flatty", theme= Bath, hash="776DECD550465EA632D4B84A11A5A71A", boardId = "hills"),
  ...
  newLevelMeta(name= "Shelf Swinger", path="levels/shelf_swinger.flatty", theme= Bookshelf, hash="CC234CD18E7B730AF326C35E17992206", boardId = "shelfswinger"),
  newLevelMeta(name= "Hooked", path="levels/hooked.flatty", theme= Bookshelf, hash="29AFFF587116A69F31787F96A8B63695", boardId = "hooked"),
  ...
  newLevelMeta(name= "Under Covers", path="levels/under_covers.flatty", theme= Bookshelf, hash="B947CC3A180999C9E010078C4CFB0C79", boardId = "undercovers"),
  ...
  newLevelMeta(name= "Rickety Bridge", path="levels/rickety_bridge.flatty", theme= Plants, hash="906BFD10F3E51ED5F7994F40BA1D7159", boardId = "ricketybridge"),
  ...
  newLevelMeta(name= "Ballistic Bowler", path="levels/ballistic_bowler.flatty", theme= Desk, hash="8485882C6B058896A368A6B99A075CF5", boardId = "ballisticbowler"),
