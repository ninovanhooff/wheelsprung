...
let officialLevels*:  OrderedTable[Path, level_data.LevelMeta] = @[
  ...
  newLevelMeta(name= "Tutorial: Gravity", path="levels/tutorial_gravity.wmj", hash="7edf5c8b86548dcfdafe9acb9d670a5d"),
  newLevelMeta(name= "Gravity Vault", path="levels/gravity_vault.wmj", hash="c017327295aec53f8c17e98332f3ad60"),
  newLevelMeta(name= "Marble Vault", path="levels/marble_vault.wmj", hash="665850195c64c027ffaf3f32062a5d89"),
  newLevelMeta(name= "Leg Up", path="levels/leg_up.wmj", hash="daef70c71a4a3a665551716f51fee5dc"),
