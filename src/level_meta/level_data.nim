...
let officialLevels*: OrderedTable[Path, LevelMeta] = @[
  ...
  newLevelMeta(name= "Killveyor", path="levels/killveyor.flatty", theme= Space, hash="854AAFEFFD113BB092E52C3187FFAECC"),
  newLevelMeta(name= "Return to sender", path="levels/return_to_sender.flatty", theme= Space, hash="49FFD120D704A5898CD5BEE2CD8A3805"),
